...
public class FeedServiceImpl implements FeedService {
    ...
    @Transactional
    public void saveFeed(AccountDetails accountDetails, FeedRequestDTO requestDTO) {
        ...
        feedRepository.save(Feed.builder()
                ...
                .userName(accountDetails.getAccount().getProfileName())
                .userProfile(accountDetails.getAccount().getProfileImage())
                .club(findClub)
                .build()
        );
    }
    ...
    public FeedListDTO createFeed(FeedRequestDTO requestDTO) {
        Club clubdata = clubService.findClubById(requestDTO.clubId());
    ...
    private Feed convertToEntity(FeedRequestDTO requestDTO) {
        Club club = clubService.findClubById(requestDTO.clubId());
