...
public interface ChatRepository extends JpaRepository<Chat, Long> {
    ...
    @Modifying
    @Query(value = "INSERT INTO chat (account_id, chat_room, raccount_id) VALUES (?1, ?2, ?3)", nativeQuery = true)
    void insertChatRoom(int accountId, String chatRoom, int raccountId);
