...
const SwiperCardSection = ({clubDetail}) => {
    ...
    return (
        ...
        eventList.length === 0 ?
            (
                <section className="mx-[20px] game-section flex flex-col justify-center items-center text-small text-stone-400"
                         style={{border: '1px solid #d7d7d7', borderRadius: '20px', height: '7em'}}>
                    <div className="flex flex-row items-center"><LuAlertCircle/>&nbsp;아직 모임이 없네요</div>
                    {
                        isLogin &&
                        <Button variant="light" color="danger" onClick={() => navigate('/feed-editor')}>
                            <u>모임 만들기</u></Button>
                    }
                </section>
            )
